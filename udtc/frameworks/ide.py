...
class EclipseLuna(udtc.frameworks.baseinstaller.BaseInstaller):
    """The Eclipse Foundation 4.4 distribution."""
    ...
    def __init__(self, category):
        ...
        super().__init__(name="Eclipse Luna",
                         description="Pure Eclipse Luna (4.4)",
                         category=category, only_on_archs=_supported_archs,
                         download_page=None,
                         dir_to_decompress_in_tarball='eclipse',
                         desktop_file_name=self.desktop_filename)
    ...
    def create_launcher(self):
        ...
        # Icon paths don't work with quotes?
        icon_path = join(self.install_path, "icon.xpm")
        ...
        create_launcher(self.desktop_filename,
                        get_application_desktop_file(name=_("Eclipse Luna"),
                                                     ...
                                                     exec=exec_path,
                                                     comment=_(
                                                         "The Eclipse Luna Integrated Development Environment"),
