...
from udtc.tools import create_launcher, get_application_desktop_file, get_current_arch

logger = logging.getLogger(__name__)


class GamesCategory(udtc.frameworks.BaseCategory):

    def __init__(self):
        super().__init__(name=_("Games"), description=_("Games Development Environment"), logo_path=None)


class Stencyl(udtc.frameworks.baseinstaller.BaseInstaller):
