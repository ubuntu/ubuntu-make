...
from udtc.interactions import DisplayMessage
from udtc.tools import get_current_arch, add_env_to_user, ChecksumType
from udtc.ui import UI

logger = logging.getLogger(__name__)


class GoCategory(udtc.frameworks.BaseCategory):
...
class GoLang(udtc.frameworks.baseinstaller.BaseInstaller):
